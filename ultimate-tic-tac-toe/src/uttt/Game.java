...
public class Game {
	...
	private DisplaySpectator spectator;
	...
	public Game(Player player1, Player player2, DisplaySpectator spectator) {
	...
	public Game(Player player1, Player player2, DisplaySpectator spectator, Board board) {
